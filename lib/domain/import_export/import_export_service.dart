...
class ImportExportService {
  ...
  Future<int> _saveImportedDecks(List<PlainDeckModel> decks) async {
    final isPremium = isSubscriptionOnly ||
    ...
    if (!isPremium) {
      ...
      if (totalAfterImport > remoteConfigService.deckLimit) {
        throw ImportLimitExceededException(
          ImportExportType.deck,
          remoteConfigService.deckLimit,
        );
      }
    }
    ...
    if (!isPremium) {
      for (final deck in decks) {
        if (deck.cards.length > remoteConfigService.quizCardLimit) {
          throw ImportLimitExceededException(
            ImportExportType.card,
            remoteConfigService.quizCardLimit,
          );
        }
      }
    }
  ...
  Future<int> _saveImportedCards(
    ...
    if (!isPremium) {
      ...
      if (totalAfterImport > remoteConfigService.quizCardLimit) {
        throw ImportLimitExceededException(
          ImportExportType.card,
          remoteConfigService.quizCardLimit,
        );
  ...
  Future<int?> restoreFromICloud() async {
    ...
    if (!isPremium) {
      ...
      if (projectedDeckCount > remoteConfigService.deckLimit) {
        throw ImportLimitExceededException(
          ImportExportType.deck,
          remoteConfigService.deckLimit,
        );
